    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#MyTable').dataTable( {
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?php echo base_url('mahasiswa/bina/ajax_list');?>",
                    "type": "POST",
                    "data": function (data) {
            ...
            $("#id_instansi").select2({
                ...
                allowClear: true,
                ajax:{
                    url: "<?php echo base_url('mahasiswa/bina/ajax_autocomplete_instansi');?>",
                    dataType: "JSON",
            ...
            $(document).on("click", ".btn-export",function() {
                var ExportURL = '<?php echo base_url('mahasiswa/bina/export');?>/';

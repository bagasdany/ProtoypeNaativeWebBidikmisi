                                ...
                                <div>
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="gelar_terakhir" class="form-control" placeholder="......" value="<?php echo set_value('gelar_terakhir');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="input-group date">
                                                    <input type="text" name="tanggal_lulus" class="form-control pull-left tanggal" autocomplete="off" onkeydown="event.preventDefault()" value="<?php echo (set_value('tanggal_lulus') ? set_value('tanggal_lulus') : date('d/m/Y'));?>">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="nama_perusahaan" class="form-control" placeholder="......" value="<?php echo set_value('nama_perusahaan');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <textarea name="alamat_perusahaan" class="form-control" rows="5" placeholder="......"><?php echo set_value('alamat_perusahaan');?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="jabatan" class="form-control" placeholder="......" value="<?php echo set_value('jabatan');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="input-group date">
                                                    <input type="text" name="tanggal_masuk" class="form-control pull-left tanggal" autocomplete="off" onkeydown="event.preventDefault()" value="<?php echo (set_value('tanggal_masuk') ? set_value('tanggal_masuk') : date('d/m/Y'));?>">
                                                    <div class="input-group-addon input-group-addon-tanggal">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
                                                </div>

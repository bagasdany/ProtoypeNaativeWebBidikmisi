    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#MyTable').dataTable( {
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?php echo base_url('master/pendidikan/ajax_list');?>",
                    "type": "POST"
                },
                "sServerMethod": "POST",
                "bAutoWidth": false,
            ...
            // TAMBAH
            $(".dataTables_length").html('<a href="<?php echo base_url('master/pendidikan/tambah');?>" class="btn bg-navy" title="Tambah" data-toggle="tooltip"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a>');

                                ...
                                <div>
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="password" name="password" class="form-control" placeholder="......" value="<?php echo set_value('password');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="nm_lengkap" class="form-control" placeholder="......" value="<?php echo set_value('nm_lengkap');?>">

    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#MyTable').dataTable( {
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?php echo base_url('master/bank/ajax_list');?>",
                    "type": "POST"
                },
                "sServerMethod": "POST",
                "bAutoWidth": false,
                ...
                "aoColumnDefs": [
                    ...
                    {'bSortable': false, 'aTargets': [ 3 ], width:90, className: 'text-center'},
                ],
            });

            // TAMBAH
            $(".dataTables_length").html('<a href="<?php echo base_url('master/bank/tambah');?>" class="btn bg-navy" title="Tambah" data-toggle="tooltip"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a>');

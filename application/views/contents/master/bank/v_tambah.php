                                ...
                                <div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="kd_bank" class="form-control" placeholder="......" maxlength="10" value="<?php echo set_value('kd_bank');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="nm_bank" class="form-control" placeholder="......" value="<?php echo set_value('nm_bank');?>">

                                ...
                                <div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="kd_instansi" class="form-control" placeholder="......" maxlength="10" value="<?php echo set_value('kd_instansi');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="nm_instansi" class="form-control" placeholder="......" value="<?php echo set_value('nm_instansi');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <textarea name="alamat_instansi" class="form-control" rows="5" placeholder="......"><?php echo set_value('alamat_instansi');?></textarea>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <div>
                                                <input type="text" name="email" class="form-control" placeholder="......" value="<?php echo set_value('email');?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="no_telepon" class="form-control" placeholder="......" value="<?php echo set_value('no_telepon');?>">
                                        ...
                                        <div class="form-group">
                                            <label>No. Fax</label>
                                            <div>
                                                <input type="text" name="no_fax" class="form-control" placeholder="......" value="<?php echo set_value('no_fax');?>">

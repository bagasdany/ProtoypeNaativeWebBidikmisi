    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#MyTable').dataTable( {
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?php echo base_url('master/instansi/ajax_list');?>",
                    "type": "POST"
                },
                "sServerMethod": "POST",
                "bAutoWidth": false,
                ...
                "aoColumnDefs": [
                    ...
                    {'bSortable': true, 'aTargets': [ 2 ], width:300},
                    {'bSortable': true, 'aTargets': [ 3 ]},
                    {'bSortable': false, 'aTargets': [ 4 ], width:90, className: 'text-center'},
                ],
            });

            // TAMBAH
            $(".dataTables_length").html('<a href="<?php echo base_url('master/instansi/tambah');?>" class="btn bg-navy" title="Tambah" data-toggle="tooltip"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a>');

        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('monitoring/data/detail/' . $ubah['id_instansi'] . '/' . url_title(strtolower($ubah['kd_instansi'])) . '/' . url_title(strtolower($ubah['nm_instansi'])));?>">Daftar Mahasiswa <?php echo $ubah['nm_instansi'];?></a>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group text-center">
                                        ...
                                        <a href="<?php echo base_url('monitoring/data/detail/' . $ubah['id_instansi'] . '/' . url_title(strtolower($ubah['kd_instansi'])) . '/' . url_title(strtolower($ubah['nm_instansi'])));?>" class="btn btn-default" title="Kembali ke daftar">
